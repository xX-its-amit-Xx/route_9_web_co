    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          {PROCESS.map((step, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div
                  className="flex items-center justify-center w-11 h-11 rounded-full bg-[#D4682A] text-[#FEFBF5] font-extrabold text-lg flex-shrink-0 group-hover:scale-110 transition-transform duration-200"
                  style={{ fontFamily: "var(--font-playfair)" }}
                >
                  {step.step}
                </div>
        ...
        <div className="mt-14 pt-10 border-t border-[rgba(212,104,42,0.1)] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <p className="text-[#9B8C7D] max-w-md">
            Ready to see what your site could look like? The meeting is free. The preview is free. You only pay when you&apos;re happy.
          </p>
          <a
            href="#contact"
            className="flex-shrink-0 inline-flex items-center h-12 px-7 rounded-xl bg-[#D4682A] hover:bg-[#C05A20] text-[#FEFBF5] text-sm font-bold transition-all duration-150 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[rgba(212,104,42,0.3)]"
          >
            Book a free meeting
          </a>
        </div>
